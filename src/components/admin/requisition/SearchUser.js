...
import { getAllPrOfUser } from '../../../api/admin';
...
export default class SearchPR extends Component {
  ...
  handleSubmit = (e) => {
    ...
    getAllPrOfUser(this.state.search).then((res) => {
    ...
    return (
      <div>
        ...
        <Form onSubmit = {this.handleSubmit}>
          <Form.Input placeholder="Search PR of User..." name="search" onChange={this.handleOnChange}/> 
        </Form>
      </div>
    );
  }
